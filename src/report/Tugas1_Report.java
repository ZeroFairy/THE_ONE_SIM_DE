...
/**
 * If forget what this for, if I'm not wrong, it was about buffer occunpancy or total contact
 */
public class Tugas1_Report extends Report implements MessageListener, UpdateListener, ConnectionListener {
...
//		Newly Added
    ...
    public void updated(List<DTNHost> hosts) {
        if ((SimClock.getIntTime() - this.lastUpdateTime) >= this.timeInterval) {
            ...
            this.totalContact.add(this.contact);
            this.deliveryRatio.add(deliveryProb);
            this.overheadRatio.add(overHead);
            this.averageLatency.add(avgLatency);
            this.totalForward.add(Double.valueOf(this.nrofRelayed));
