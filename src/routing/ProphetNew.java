 ...
 */
public class ProphetNew extends ActiveRouter {
    ...
    public static final String PROPHET_NS = "ProphetNew";
    /**
     ...
     */
    protected ProphetNew(ProphetNew r) {
        super(r);
    ...
    private void updateTransitivePreds(DTNHost host) {
        ...
        assert otherRouter instanceof ProphetNew : "PRoPHET only works " +
                " with other routers of same type";

        double pForHost = getPredFor(host); // P(a,b)
        Map<DTNHost, Double> othersPreds =
                ((ProphetNew)otherRouter).getDeliveryPreds();
    ...
    protected Tuple<Message, Connection> tryOtherMessages() {
        ...
        for (Connection con : getConnections()) {
            ...
            ProphetNew othRouter = (ProphetNew)other.getRouter();
            ...
            for (Message m : msgCollection) {
                if (m.getTo() == other) {
                    ...
                    othRouter.updatePrevDeliveryPredFor(m.getTo());
                    continue;
                }
    ...
    private class TupleComparator implements Comparator
        ...
        public int compare(Tuple<Message, Connection> tuple1,
            ...
            double p1 = ((ProphetNew)tuple1.getValue().
                    getOtherNode(getHost()).getRouter()).getPredFor(
                    tuple1.getKey().getTo());
            // -"- tuple2...
            // p2 is reference tuple1
            double p2 = ((ProphetNew)tuple2.getValue().
                    getOtherNode(getHost()).getRouter()).getPredFor(
                    tuple2.getKey().getTo());
    ...
    public MessageRouter replicate() {
        ProphetNew r = new ProphetNew(this);
        return r;
    }
}
